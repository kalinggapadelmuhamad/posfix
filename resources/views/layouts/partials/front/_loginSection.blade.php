    @if (session()->has('error'))
        <div aria-live="polite" aria-atomic="true" class="position-relative">
            <div class="toast-container top-0 end-0 p-3">
                ...
                <div class="toast shadow border-0 border-start border-5 border-danger rounded-0" role="alert"
                    aria-live="assertive" aria-atomic="true" style="width: fit-content;">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-secondary" type="button" id="button-addon2"><i
                                    class="bi-eye-slash-fill" id="togglePassword"></i></button>
                        </div>
                    </div>
                    <div class="d-grid">
